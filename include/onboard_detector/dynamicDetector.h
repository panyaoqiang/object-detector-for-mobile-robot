...
namespace onboardDetector{
    ...
    private:
        ...
        // Subscriber
        rclcpp::Subscription<sensor_msgs::msg::CompressedImage>::SharedPtr depthSub_;
        rclcpp::Subscription<sensor_msgs::msg::CompressedImage>::SharedPtr colorImageSub_;
        rclcpp::Subscription<vision_msgs::msg::Detection2DArray>::SharedPtr yoloDetectionSub_;
        rclcpp::Subscription<std_msgs::msg::Float32MultiArray>::SharedPtr yoloKeypointSub_;
        ...
        rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr filteredPointCloudPub_; // DBSCAN filtered point cloud
        ...
        rclcpp::Publisher<geometry_msgs::msg::PointStamped>::SharedPtr yoloUvCenterPub_;
        ...
        std::vector<Eigen::Vector3d> projPointsCam_; // projected points from depth image in camera frame
        ...
        std::vector<std::vector<Eigen::Vector2d>> parsedKeypoints_; // yolo detected keypoints
        cv::Mat detectedColorImage_;

    
    public:
        dynamicDetector(const rclcpp::NodeOptions& options = rclcpp::NodeOptions());
        void initParam();
        void registerPub();
        ...
        // callback
        void depthImgCB(const sensor_msgs::msg::CompressedImage::ConstSharedPtr& img);
        void colorImgCB(const sensor_msgs::msg::CompressedImage::ConstSharedPtr& img);
        void yoloDetectionCB(const vision_msgs::msg::Detection2DArray::ConstSharedPtr& detections);
        void yoloKeypointCB(const std_msgs::msg::Float32MultiArray::ConstSharedPtr& keypoints);
        void detectionCB();
        void trackingCB();
        ...
        void publishPoints(const std::vector<Eigen::Vector3d>& points, const rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr& publisher, const std::string& frame_id = "map");
