...
namespace onboardDetector{
    ...
    class UVdetector
    {
        ...
        float min_height; // minimum physical height in meters
        float max_height; // maximum physical height in meters
        ...
        std::vector<cv::Rect> rois_; // Regions of Interest derived from YOLO bounding boxes
